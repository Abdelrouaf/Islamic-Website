...
export default function EditMonotheism() {
                ...
                <div className="col-lg-4">
                    ...
                    <ul className={`${style.listMenu} mb-3 pb-2`}>
                        ...
                        <li>
                            ...
                            <NavLink to='create/topic' className={({isActive}) => { return ( ` ${style.link} ` + (isActive ? ` ${style.linkActive} `: `  ` ) ) } }><i className="fa-solid fa-folder-plus"></i>create</NavLink>
