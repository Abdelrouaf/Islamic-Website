...
export default function MonotheismTopic() {
    ...
    //     const fetchTopic = async () => {
    //         try {
    //             const response = await axios.get(`http://localhost:8080/api/monotheismBlog/${id}`);
    //             // if (response !== 200) {
    //             //     throw new Error(`HTTP error! status: ${response.status}`);
    //             // }
                
    //             // const topicData = await response.json();
    //             const finalData = response.data.Blog[0]; 
    ...
    //         const response = await axios.put(`http://localhost:8080/api/monotheismBlog/${formData.id}`, formData);
    
    //         // const responseData = await response.json();
        
    //         if (response.status === 200) {
    //             alert('Topic updated successfully!');
    //             navigate(`/en/monotheism/topic/${formData.id}`);
