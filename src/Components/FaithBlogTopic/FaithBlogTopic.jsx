...
export default function FaithBlogTopic() {
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            if(checkData.videoName !== formData.videoName) {
                payload.append('videoName', formData.videoName);
                isPayloadChanged = true
            }

            if(checkData.author !== formData.author) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                fetchData();
                setTimeout( () => {
                    navigate('/en/dashboard/islamic/faith/blog/create');
                }, 6000 )
            } else {
                    ...
                    {/* <div className="mb-4">
                        ...
                        <div className={`${layout.rightInput} ${layout.input} w-100`}>
                            <input
                                ...
                                id="author" // Matches formData.title
                    ...
                    <div className="mb-4">
                        ...
                        <div className={`${layout.rightInput} ${layout.input} w-100`}>
                            <input
                                ...
                                id="videoName" // Matches formData.title
