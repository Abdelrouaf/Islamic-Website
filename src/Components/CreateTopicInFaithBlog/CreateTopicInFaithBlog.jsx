                    ...
                    <div className={layout.inputs}>
                        ...
                        <div className="mb-4">
                            ...
                            <div className={`${layout.rightInput} ${layout.input} w-100`}>
                                ...
                                <input required type="text" className='form-control py-2' placeholder='enter blog title' id="title"
                        ...
                        <div className="mb-4">
                            ...
                            <div className={`${layout.rightInput} ${layout.input} w-100`}>
                                ...
                                <input required type="text" className='form-control py-2' placeholder='enter blog author' id="author"
                        ...
                        <div className="mb-4">
                            ...
                            <div className={`${layout.rightInput} ${layout.input} w-100`}>
                                ...
                                <input required type="file" className='form-control py-2' placeholder='enter video file' id="videoName"
